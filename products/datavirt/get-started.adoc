...
== Step1 Content
1. Download Jboss Data Virtualization Installer from the following link 	" http://www.jboss.org/products/datavirt/download/ "
2. Open a terminal window and navigate to the location where the GUI installer was downloaded.
3.	Enter the following command to launch the GUI installer: `java -jar jboss-dv-installer-VERSION.jar`
...
..	In Red Hat JBoss Developer Studio, *click Help > Install* New Software…action from the main menu.
..	On the Available Software page, click the *Add …* button.
..	On the Add Repository dialog, enter following details:
...
..	Click *OK*.
..	In the update site tree view, select the JBoss Data Virtualization Development folder and all its children.
+
...
+
*Note:* When installation is complete you will be prompted to re-launch Red Hat JBoss Developer Studio to insure the new features are fully operational.
